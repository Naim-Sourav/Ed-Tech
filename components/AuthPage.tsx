        ...
        <div className="relative z-10 p-12 text-white max-w-lg">
          ...
          <div className="flex gap-4">
             ...
             <div className="px-4 py-2 bg-white/10 rounded-lg backdrop-blur-sm border border-white/20">
                ...
                <p className="text-sm text-purple-100">Tests</p>
             </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md space-y-6">
           ...
           <form onSubmit={handleSubmit} className="space-y-4">
             ...
             <button
               type="submit"
               disabled={loading}
               className="w-full bg-primary hover:bg-purple-700 text-white font-bold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-purple-900/20 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
             >
               {loading ? (
