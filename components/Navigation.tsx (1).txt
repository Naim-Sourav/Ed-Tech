          ...
          <>
            ...
            >
               ...
               <div className="p-3 border-b border-gray-100 dark:border-white/[0.05] bg-gray-50 dark:bg-black">
                ...
                {/* Debug FCM Token Section */}
                {isPushSubscribed && (
                    <div className="px-4 py-3 bg-gray-50 dark:bg-zinc-900 border-b border-gray-100 dark:border-white/[0.05]">
                        <div className="flex justify-between items-center mb-2">
                            <h4 className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Debug Info (FCM Token)</h4>
                            {!fcmToken && (
                                <button 
                                    onClick={handleEnablePush}
                        ...
                        {fcmToken ? (
                            <div className="flex items-center gap-2">
                                <input 
                                    readOnly 
                                    value={fcmToken} 
                                    className="flex-1 bg-white dark:bg-black border border-gray-100 dark:border-white/[0.05] rounded-lg px-2 py-1 text-[8px] font-mono text-gray-500 truncate"
                                />
                                <button 
                                    onClick={() => {
                                    ...
                                    className="p-1.5 bg-white dark:bg-black border border-gray-100 dark:border-white/[0.05] rounded-lg text-primary"
                                >
                                    <Copy size={12} />
                                </button>
                            </div>
                        ) : (
                            <p className="text-[9px] text-gray-400 italic">টোকেন লোড হচ্ছে বা পাওয়া যায়নি...</p>
                        )}
                        <p className="text-[8px] text-gray-400 mt-1 italic">* এই টোকেনটি Firebase-এ "Test Message" পাঠানোর জন্য ব্যবহার করুন।</p>
                    </div>
                )}
