          ...
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              <button 
                ...
                className={`px-8 py-4 rounded-2xl font-black flex items-center gap-3 transition-all active:scale-95 shadow-2xl ${isSubscribed ? 'bg-emerald-500 text-white shadow-emerald-500/20' : 'bg-primary text-white shadow-primary/30 hover:scale-105'}`}
              >
                {isSubscribed ? <CheckCircle2 size={20} /> : <Bell size={20} className="animate-bounce" />}
                {isSubscribed ? 'সাবস্ক্রাইব করা হয়েছে' : 'রেজাল্ট এলার্ট চালু করুন'}
              </button>
              <button 
                onClick={handleShare}
      ...
      <div className="max-w-4xl mx-auto px-4 mt-12 space-y-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            { label: 'বিশ্ববিদ্যালয় সংখ্যা', value: '২৪টি', icon: Zap, color: 'text-purple-500 bg-purple-50' },
          ].map((stat, i) => (
