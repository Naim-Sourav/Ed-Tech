...
const WrongQuestions: React.FC<WrongQuestionsProps> = ({ embedded = false }) => {
  ...
  const { uniqueSubjects, uniqueChapters, subjectCounts, chapterCounts } = useMemo(() => {
        ...
        <div className="space-y-4">
          {loading ? (
            ...
            <EmptyState
              ...
              message="সব পরিষ্কার! কোনো ভুল প্রশ্ন পাওয়া যায়নি।"
            />
          ) : (
              ...
              {displayedItems.map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 gap-1.5 mb-2 pl-0 md:pl-6">
                        ...
                        return (
                          <div 
                            ...
                            className={`p-2 rounded-xl border transition-all flex items-center gap-3 ${optionStyle} ${
                              !isQuestionResolved && !isSelectionMode ? 'cursor-pointer hover:border-slate-300 dark:hover:border-zinc-700' : ''
                            }`}
                          >
                    ...
                    <div className="mt-3 pt-3 border-t border-slate-55 dark:border-zinc-800 flex items-center justify-between">
                      ...
                      {!isSelectionMode && (
                        <button 
                          ...
                          className="p-1.5 text-slate-400 hover:text-red-500 transition-all border border-transparent rounded-lg hover:bg-slate-50 dark:hover:bg-zinc-800 shrink-0"
                        >
                          <Trash2 size={14} />
                        </button>
                      )}
