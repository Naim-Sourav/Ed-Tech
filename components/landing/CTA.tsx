...
import { Reveal, EASE_SPRING, formatBn } from './ui';

const words = ['প্র্যাকটিস', 'মক এক্সাম', 'অ্যানালাইজ', 'রিভিশন', 'জয়'];

const CTA: React.FC<{ onLoginClick: () => void }> = ({ onLoginClick }) => {
  return (
          ...
          <div className="noise relative overflow-hidden rounded-[32px] bg-ink shadow-[0_60px_120px_-50px_rgba(22,18,16,0.9)] sm:rounded-[44px]">
            ...
            <div className="relative px-6 pb-24 pt-20 text-center sm:px-12 sm:pt-28">
              ...
              >
                ...
                পরীক্ষার হলে দেখবে তোমার নতুন রূপ
              </motion.span>

              <h2 className="mx-auto mt-7 max-w-3xl text-balance font-bangla text-[36px] font-extrabold leading-[1.14] tracking-[-0.01em] text-white sm:text-[56px]">
                তোমার GPA-5 যুগ{' '}
                <span className="bg-gradient-to-r from-lime to-brand-bright bg-clip-text text-transparent">
                  আজ রাতেই শুরু।
                </span>
              </h2>
              ...
              <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                >
                  ...
                  <span className="grid h-6 w-6 place-items-center rounded-full bg-ink text-lime transition-transform duration-300 group-hover:translate-x-1" aria-hidden="true">
              ...
              <p className="mt-6 text-[13px] font-medium text-white/45">
                <span className="font-bold text-lime">{formatBn(20000)}+</span> প্রশ্ন ইতিমধ্যে অঙ্গনে · শুরু করতে কোনো কার্ড লাগবে না
              </p>
            </div>
