...
const FaqItem: React.FC<{ q: string; a: string; open: boolean; onToggle: () => void; index: number }> = ({
  q,
  a,
  open,
  onToggle,
  ...
  <div className="border-b border-ink/10">
    ...
    >
      <span className="flex items-baseline gap-4">
        ...
        <span
          className={`font-bangla text-[16.5px] font-bold transition-colors duration-300 sm:text-[18px] ${
          ...
          <div className="lg:sticky lg:top-28 lg:self-start">
            <Reveal>
              ...
              <p className="mt-4 max-w-sm text-[15.5px] leading-relaxed text-mist">
                শিক্ষার্থীরা যেসব প্রশ্ন সবচেয়ে বেশি করে — সবগুলোর উত্তর একসাথে। না পেলে সরাসরি নক দাও।
              </p>
            </Reveal>
              ...
              <div className="rounded-[22px] bg-mint p-6 ring-1 ring-brand/15">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[13px] font-medium text-brand-deep">টেলিগ্রামে নক করো — মানুষ উত্তর দেবে</p>
                  </div>
                </div>
